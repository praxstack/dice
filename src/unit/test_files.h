...
int test_observeFingerprint(int argc, char **argv, int flags);
int test_unobserveFingerprint(int argc, char **argv, int flags);
...
unitTest __test_observe_c[] = {{"test_generateCommandFingerprint", test_generateCommandFingerprint}, {"test_observeFingerprint", test_observeFingerprint}, {"test_unobserveFingerprint", test_unobserveFingerprint}, {"test_freeObserveCommandInfo", test_freeObserveCommandInfo}, {"test_initObserveDebounce", test_initObserveDebounce}, {"test_observeDebounceKeyChange", test_observeDebounceKeyChange}, {"test_observeDebounceFlush", test_observeDebounceFlush}, {"test_observeNotifyKeyChangeImmediate", test_observeNotifyKeyChangeImmediate}, {"test_observeNotifyKeyChangeDebounced", test_observeNotifyKeyChangeDebounced}, {NULL, NULL}};
...
struct unitTestSuite {
    ...
    {"test_observe.c", __test_observe_c},
