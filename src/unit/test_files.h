...
unitTest __test_observe_c[] = {{"test_generateCommandFingerprint", test_generateCommandFingerprint}, {"test_observeSubscribeFingerprint", test_observeSubscribeFingerprint}, {"test_observeUnsubscribeFingerprint", test_observeUnsubscribeFingerprint}, {"test_freeObserveCommandInfo", test_freeObserveCommandInfo}, {"test_initObserveDebounce", test_initObserveDebounce}, {"test_observeDebounceKeyChange", test_observeDebounceKeyChange}, {"test_observeDebounceFlush", test_observeDebounceFlush}, {"test_observeNotifyKeyChangeImmediate", test_observeNotifyKeyChangeImmediate}, {"test_observeNotifyKeyChangeDebounced", test_observeNotifyKeyChangeDebounced}, {NULL, NULL}};
